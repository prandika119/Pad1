...
@section('content')
    ...
    <form method="POST" action="{{ route('setPassword.update', $user->id) }}" class="max-w-sm mx-auto">
        @csrf
        @method('PUT')
        <div class="mb-5">
        ...
        <div class="mb-5">
            <label for="repeat_password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
